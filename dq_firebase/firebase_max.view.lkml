...
view: firebase_max {
  sql_table_name: `lk-datawarehouse-2.dragqueen_firebase.firebase_max`
    ;;

  dimension_group: __execution {
    type: time
    timeframes: [
      raw,
      date,
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}.__execution_date ;;
  }

  dimension_group: __extracted {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.__extracted_at ;;
  }

  dimension: __row_uuid {
    type: string
    sql: ${TABLE}.__row_uuid ;;
  }
  ...
  dimension: platform_1 {
    type: string
    sql: ${TABLE}.platform_1 ;;
  }
  ...
  dimension: uar_platform {
    type: string
    sql: ${TABLE}.uar_platform ;;
  }
...
view: firebase_max__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: firebase_max__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
