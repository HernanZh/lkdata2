view: dq_events {
  sql_table_name: dragqueen_firebase.events ;;
...
### device dimensions
  ...
  dimension_group: event {
    type: time
    timeframes: [date, week, day_of_week, month, year,raw]
...
view: dq_events__user_properties__value {

  dimension: double_value {
    required_fields: [dq_events__user_properties.key]
    type: number
...
view: dq_events__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dq_events__traffic_source {
  dimension: medium {
...
view: dq_events__event_params__value {

  dimension: double_value {
    required_fields: [dq_events__event_params.key]
    type: number
    sql: ${TABLE}.double_value ;;
  }
...
#   required_fields: [dq_events__event_params.key]
#   type: number
#   sql: ${dq_events__event_params__value}.double_value ;;
# }

view: dq_events__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dq_events__event_dimensions {
  dimension: hostname {
    type: string
    sql: ${TABLE}.hostname ;;
  }
...
view: dq_events__device__web_info {
  dimension: browser {
    type: string
    sql: ${TABLE}.browser ;;
  }
